...
def mul(k: int, u: int, bits: int, p: int, a24: int):
    ...
    if(debug):
        print(" x_1 = ", hex(x_1.val))
        print(" x_2 = ", hex(x_2.val))
        print(" z_2 = ", hex(z_2.val))
        print(" x_3 = ", hex(x_3.val))
        print(" z_3 = ", hex(z_3.val))
    for t in range(bits-1, -1, -1):
        k_t = (k >> t) & 1
        swap ^= k_t
        if(debug):
            print(" --in loop-- t = ", t," k_t = ",k_t," swap = ", swap)
            print(" b4 cswap : \n")
            print(" x_2 = ", hex(x_2.val))
            print(" x_3 = ", hex(x_3.val))
            print(" z_2 = ", hex(z_2.val))
...
def x25519(k: bytes, u: bytes):
    ...
    if(debug):
        print(" type(k) = ",type(k), " type(u) = ", type(u))
        print(" (k) = ",hex(k), " \n (u) = ", hex(u))
    p = 2**255 - 19
    a24 = 121665
...
if __name__ == '__main__':
    ...
    k = binascii.unhexlify(
        b'c8d74acde5934e64b9895d5ff7afbffd7f704f7dfccff7ac28fa62a1e6410347')
    u = binascii.unhexlify(
        b'e0eb7a7c3b41b8ae1656e3faf19fc46ada098deb9c32b1fd866205165f49b880')
